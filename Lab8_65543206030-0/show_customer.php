...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td style='border: 1px solid black; padding: 10px;'><a href='show_customer.php?id=".$row['Customer_id']."'onclick='return confirm(\"ต้องการลบลูกค้าคนนี้?\");'><img src='1.png' alt='ลบ' style='width:16px; height:16px;'></a></td>";
        echo "</tr>";
    }
    echo "</table>";
